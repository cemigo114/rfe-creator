...
2. MCP fallback (only if step 1 exited with code 2):
   a. Call mcp__atlassian__getJiraIssue with cloudId="https://redhat.atlassian.net", issueIdOrKey="{KEY}", fields=["summary","description","priority","labels","status"], responseContentFormat="markdown"
